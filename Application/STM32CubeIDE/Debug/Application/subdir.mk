...
Application/startup_stm32wl55jcix.o: ../Application/startup_stm32wl55jcix.s Application/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I../../Application/Core/Inc -I../../Core/Radio -x assembler-with-cpp -MMD -MP -MF"Application/startup_stm32wl55jcix.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
